...
define :update_records do
  ...
  hash =  { hosted_zone_id: node["aws"]["route53"]["zone_id"],
            change_batch: { comment: "optional",
                            changes: [{ action: params[:record_action],
                                         resource_record_set: { name: params[:record_name],
                                                                type: params[:type],
                                                                ttl: params[:ttl],
                                                                resource_records: [{ value: params[:value] }]
                                                              }
                                      }]
                        }
          }
