...
node.default["ecom-platform"].environment_variables["APP_URL"]="https://#{node["ecom-platform"]["cname"]}"
app_environment_variables = {}
app_environment_variables.merge! node["ecom-platform"].environment_variables
app_environment_variables.merge! settings


node.override["ecom-platform"].environment_variables = app_environment_variables
